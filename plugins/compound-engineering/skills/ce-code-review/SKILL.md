...
- **Clean before the review:** after applying and verifying, commit the fixes as one isolated `fix(review): <summary>` commit — labeled and reversible, returning the tree to a known state.
